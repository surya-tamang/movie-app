...
export default function Pagination({ pageValue, prevClick, nextClick }) {
    ...
    return (
        <>
            ...
            <div className="inline-flex items-center justify-center rounded bg-blue-600 py-1 text-white">
                <a href="#" className="inline-flex size-8 items-center justify-center rtl:rotate-180" onClick={prevClick}>
                ...
                <a href="#" className="inline-flex size-8 items-center justify-center rtl:rotate-180" onClick={nextClick}>
